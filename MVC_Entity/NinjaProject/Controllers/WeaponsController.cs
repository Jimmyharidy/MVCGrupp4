...
namespace NinjaProject.Controllers
{
    public class WeaponsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "WeaponId,Name,Weight,Range")] Weapon weapon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "WeaponId,Name,Weight,Range")] Weapon weapon)
        {
            if (ModelState.IsValid)
            {
